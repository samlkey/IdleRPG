...
export class WoodcuttingComponent {
  ...
  private readonly allDropTables: DropTable[] = [
    ...
    },
    {
      id: 'oak-tree', name: 'Oak Tree', drops: [
        { item: this.itemService.searchItemById('oak-log')!, chance: 1, qty: 1 },
      ],
    },
    {
      id: 'willow-tree', name: 'Willow Tree', drops: [
        { item: this.itemService.searchItemById('willow-log')!, chance: 1, qty: 1 },
      ],
    },
    {
      id: 'maple-tree', name: 'Maple Tree', drops: [
        { item: this.itemService.searchItemById('maple-log')!, chance: 1, qty: 1 },
      ],
    },
    {
      id: 'yew-tree', name: 'Yew Tree', drops: [
        { item: this.itemService.searchItemById('yew-log')!, chance: 1, qty: 1 },
      ],
    },
    {
      id: 'magic-tree', name: 'Magic Tree', drops: [
        { item: this.itemService.searchItemById('magic-log')!, chance: 1, qty: 1 },
      ],
    },
  ];
  ...
  private readonly allTrees = [
    ...
    { name: 'Oak Tree',     src: 'assets/objects/oak_tree.png',        level: 15, xp: 37.5, time: 10, critChance: 0.4, disabled: true,  dropTable: this.allDropTables[1] },
    { name: 'Willow Tree',  src: 'assets/objects/willow_tree.png',     level: 30, xp: 67.5, time: 15, critChance: 0.4, disabled: true,  dropTable: this.allDropTables[2] },
    { name: 'Maple Tree',   src: 'assets/objects/maple_tree.png',      level: 45, xp: 100,  time: 20, critChance: 0.4, disabled: true,  dropTable: this.allDropTables[3] },
    { name: 'Yew Tree',     src: 'assets/objects/yew_tree.png',        level: 60, xp: 175,  time: 30, critChance: 0.4, disabled: true,  dropTable: this.allDropTables[4] },
    { name: 'Magic Tree',   src: 'assets/objects/magic_tree.png',      level: 75, xp: 250,  time: 60, critChance: 0.4, disabled: true,  dropTable: this.allDropTables[5] },
  ];
